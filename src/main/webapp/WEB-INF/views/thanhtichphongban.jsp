...
<div class="container">
		...
		<div class="box-body">
			...
			<ul class="pagination">
    <li class="page-item disabled"><a class="page-link" href="thanhtichphongban.jsp">Previous</a></li>
    <li class="page-item"><a class="page-link" href="thanhtichphongban.jsp">1</a></li>
    <li class="page-item"><a class="page-link" href="thanhtichphongban.jsp">2</a></li>
    <li class="page-item"><a class="page-link" href="thanhtichphongban.jsp">3</a></li>
    <li class="page-item"><a class="page-link" href="thanhtichphongban.jsp">Next</a></li>
  </ul></div>
		</div>
		</div>
